          ...
          <form action="/api/transactions/deposit" method="POST">
            <div class="card-form__inner">
              ...
              <div class="card-input">
                <label class="card-input__label">Select Account</label>
                <div>
              ...
              <div class="card-input">
                ...
                <input type="text" maxlength="50" name="description" class="card-input__input"
                  placeholder="Enter a deposit Description" autocomplete="off" />
              </div>
              <div class="card-input">
                <label for="cardName" class="card-input__label">Amount</label>
                <input type="number" maxlength="10" name="amount" class="card-input__input" placeholder="Enter amount"
                  autocomplete="off" />
              </div>

              <button class="card-form__button">Deposit</button>
            </div>
          </form>
        </div>
      </div>